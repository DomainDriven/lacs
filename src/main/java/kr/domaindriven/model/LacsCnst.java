 ...
 */
public class LacsCnst {

    /**
     * task 항목과 관련된 상수.
     */
    public static final String CAST_INSTRUCTOR = "강사 섭외";
    public static final String CAST_INSTRUCTOR_URL = "/castingInstructor";
    public static final String RESERVE_PLACE = "장소 예약";
